...
static const _Sum_Request_type_support_symbol_names_t _Sum_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface_demo, srv, Sum_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interface_demo, srv, Sum_Request)),
  }
};
...
{
  return &::base_interface_demo::srv::rosidl_typesupport_cpp::Sum_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interface_demo, srv, Sum_Request)() {
  return get_message_type_support_handle<base_interface_demo::srv::Sum_Request>();
}
...
static const _Sum_Response_type_support_symbol_names_t _Sum_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface_demo, srv, Sum_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interface_demo, srv, Sum_Response)),
  }
};
...
{
  return &::base_interface_demo::srv::rosidl_typesupport_cpp::Sum_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interface_demo, srv, Sum_Response)() {
  return get_message_type_support_handle<base_interface_demo::srv::Sum_Response>();
}
...
static const _Sum_type_support_symbol_names_t _Sum_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface_demo, srv, Sum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interface_demo, srv, Sum)),
  }
};
...
{
  return &::base_interface_demo::srv::rosidl_typesupport_cpp::Sum_service_type_support_handle;
}
